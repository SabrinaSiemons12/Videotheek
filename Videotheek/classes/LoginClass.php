<?php
	...
	class LoginClass
	{
		...
		*/
		...
		{
			$to = $post['emailadres'];
			$subject = "Activatiemail Vids.";
			$message = "Geachte heer/mevrouw <b>".$post['naam']."</b><br>";
			$message .= '<style>a { color:red;}</style>';
			$message .= "Hartelijk dank voor het registreren bij Vids."."<br>";
			$message .= "klik <a href='http://localhost/2016-2017/Videotheek/index.php?content=activate&email="."&emailadres=".$post['emailadres']."&wachtwoord=".$wachtwoord."'>hier</a> om uw account te activeren"."<br>";
			$message .= "U kunt dan vervolgens een nieuw wachtwoord instellen."."<br>";
			$message .= "Met vriendelijke groet,"."<br>";
			$message .= "Sabrina Siemons"."<br>";
